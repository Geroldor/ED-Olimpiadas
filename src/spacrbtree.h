 ...
 * O significado dos valores de tal descritor � definido pela aplicacao.
 * A ancora determina a relacao de ordem entre os elementos armazenada na arvore. Sejam dois 
 * nos da arvore: s e t. 
 ...
 * categorias, um categoria espec�fica da informacao i.
...
boo removeSrbT(SpacRbTree t, double x, double y, double epsilon);
/*
 * Remove o no' n da arvore t, para o qual getNodeSrbT retornaia um valor diferente de NULL.
 * Neste caso, retorna true; caso contrario, false.
 */
